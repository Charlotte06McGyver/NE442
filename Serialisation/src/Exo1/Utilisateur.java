...
public class Utilisateur extends JFrame
{
	...
	public void consulter()
	{
		try
		{
			...
			if (solde != -1)
				champStatut.setText("Consultation bien d�roul�e...");
			else
				champStatut.setText("Consultation mal d�roul�e...");
		}
	...
	public void crediter()
	{
		try
		{
			...
			if (resultat) {
				champStatut.setText("Operation bien déroulée.");
			}
			else {
				champStatut.setText("Operation mal déroulée.");
			}
		}
		catch(NumberFormatException e) {
			champStatut.setText("Attention : saisie incorrecte !");
	 ...
	 * @return
	 */
	public void debiter(/* � compl�ter si besoin */)
	{
		try
		{
			int code = Integer.parseInt(champNumCompte.getText());
